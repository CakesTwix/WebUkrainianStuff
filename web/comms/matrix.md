...
- ~~Вхід вільний.~~
  - З міркувань безпеки (щоб уникнути педофілів та інших небажаних осіб) ми вирішили додати токен для реєстрації:  
    `6wVzmnnMds4p`.
    - Якщо токен уже не працює, звʼяжіться зі мною в Matrix: [@grandboss:matrix.co.ua](https://matrix.to/#/@grandboss:matrix.co.ua) або напишіть на пошту `ce.xani@matrix.co.ua`. Я видам новий токен та оновлю інформацію на цій сторінці.
    - Якщо ж не хочете звʼязуватися, просто дочекайтеся, поки я оновлю дані.
- Постійна підтримка та оновлення.
- Щоденні бекапи.
- Має сервіс ідентифікації користувачів для пошуку по пошті (якщо ті кого шукаєте увімкнули цю функцію).
- Має можливість захищених дзвінків включно з відео.
- Має підтримку нових matrix-клієнтів Element X та SchildiChat Next.
- Має підтримку дзвінків у нових клієнтах (_захищений протокол WebRTC, десь до 10 осіб, включно з веб-камерою_).
...
- Має підтримку реєстрації та входу через SSO (_Single Sign-On – єдиний вхід через Google, GitHub, GitLab_).
...
### [**glitchy.social**](https://www.glitchy.social/uk)
  - Український сервер Matrix зі Львова
  - Щоденні бекапи
  - Реєстрація, наразі, [лише за токенами](https://www.glitchy.social/uk/docs/matrix/join)
  - Має веб-версію [Element](https://element.glitchy.social/)
  - Має міст у Telegram
...
### **Збагачене спілкування ☣️** - `#chat:matrix.co.ua`
...
### **Український простір по-новому** - `#space:matrix.co.ua`
  - Об'єднує простір **Патріотична Україна**
  - Наповнений новими кімнатами, що сформовані у 2025–2026 роках
