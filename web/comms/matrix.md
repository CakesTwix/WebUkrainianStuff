...
### **Збагачене спілкування ☣️** - `#chat-ua:glitchy.social`
  - Головна локація для загального спілкування спільноти.
  - **Безпека**: У кімнаті увімкнено наскрізне шифрування (E2EE). Переконайтеся, що ваш клієнт підтримує шифрування, щоб мати змогу читати та надсилати повідомлення.
