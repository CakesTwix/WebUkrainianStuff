...
- Має мости для телеграму (_отримання новин та інформації з каналів_), надалі можуть розширяти мережу для інших месенджерів (_Discord, Whatsapp, Signal тощо_).
- Має можливість завантажувати файли до 2 ГБ одним файлом.
- Має підтримку реєстрації та входу через SSO (_Single Sign-On – єдиний вхід через Google, GitHub, GitLab, Mastodon та Forgejo (власний Git репозиторій)_).
