...
Тут також є ПЗ, яке не базується на Mastodon, але працює як й Mastodon, на протоколі ActivityPub, що позволяє писати між інстансами різних сервисов
...
Поки немає актуальних серверів Misskey.
...
- #### [**Mastodon**](https://f-droid.org/en/packages/org.joinmastodon.android/) <Badge type="info" text="Official Client" />
- #### [**Moshidon**](https://f-droid.org/en/packages/org.joinmastodon.android.moshinda/) <Badge type="tip" text="MD3/MY" />
- #### [**Aria for Misskey**](https://f-droid.org/en/packages/com.poppingmoon.aria/) <Badge type="warning" text="For Misskey/Sharkey" />
- #### [**Kaiteki**](https://apt.izzysoft.de/fdroid/index/apk/moe.craftplacer.kaiteki) <Badge type="tip" text="MD3/MY" /> <Badge type="warning" text="For Misskey/Sharkey" />
