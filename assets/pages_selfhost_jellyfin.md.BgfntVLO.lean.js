import{_ as h,C as r,o as k,c as d,E as n,ai as t,w as l,j as s,a as i}from"./chunks/framework.B2B1VwZm.js";const v=JSON.parse('{"title":"Jellyfin - Власний медіа сервер","description":"","frontmatter":{},"headers":[],"relativePath":"pages/selfhost/jellyfin.md","filePath":"pages/selfhost/jellyfin.md","lastUpdated":1752348095000}'),o={name:"pages/selfhost/jellyfin.md"};function c(g,a,y,u,m,b){const E=r("Banner"),e=r("PluginTabsTab"),p=r("PluginTabs");return k(),d("div",null,[n(E,{text:"Jellyfin",image:"/pages/selfhost/jellyfin.png",blur:"5px"}),a[6]||(a[6]=t("",7)),n(p,null,{default:l(()=>[n(e,{label:"docker-compose.yml"},{default:l(()=>[...a[0]||(a[0]=[s("div",{class:"language-docker vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"docker"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"services:")]),i(`
